...
| E2 | `SI_E2` | Record closings of elementary schools | Ordinal scale | 0 - no measures <br/>1 - fully open (under certain hygenic and social distancing conditions) <br/>2 - partially open <br/>3 - require closing (or work from home) for all-but-essential workplaces (eg grocery stores, doctors) <br/>3 - closed <br/> -100 - no data|
...
| E4 | `SI_E4` | Record closings of schools for grades 11 to 12/13| Ordinal scale | 0 - no restrictions <br/>1 - fully open (under certain hygenic and social distancing conditions) <br/>2 - partially open <br/>3 - closed <br/> -100 - no data|
